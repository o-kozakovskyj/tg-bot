...
const BotsContainer = () => {
  ...
  const botsData = [
    {
      id: 1,
      botName: "Chatty Charlie",
      status: "active",
      updatedDate: "23/09/23",
      createdDate: "23/03/24",
      cta: "offer",
      usersIdList: [1],
    },
    {
      id: 2,
      botName: "Botanica Tester",
      status: "disabled",
      updatedDate: "23/09/23",
      createdDate: "23/03/24",
      cta: "offer",
  ...
  return (
    <div>
      <div className="bot_header">
        ...
        <button className="bot_button" onClick={handleCreateBot}>
          Create Bot
        </button>
      </div>
      <div className="bot_created">
        ...
        {botsData
          ...
          .map((botData) => (
            <Bot botData={botData} key={botData.id} />
          ))}
      </div>
    </div>
  );
